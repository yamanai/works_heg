...
export class RoundTripOrder extends FlightOrder {
  ...
  getCheckPriceJsonParm() {
    ...
    //   discountPrice: self.getDepartFlight().bfp + self.getDepartFlight().gst
    //   // -self.getDepartFlight().airlineDIS
    // };
    ...
    //   discountPrice: self.getReturnFlight().bfp + self.getReturnFlight().gst
    //   // -self.getReturnFlight().airlineDIS
    // };
