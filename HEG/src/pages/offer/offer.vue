	...
	<div class="wrapper">
		<div class="offer">
			...
			<!-- <div class="offer-cont">
																																																							<div class="offer-list">
																																																								...
																																																								<div class="offer-info flex">
																																																									<div class="left">
																																																										<h2>
																																																											<span class="title">Book with your cashback price</span>
																																																										</h2>
																																																									</div>
																																																						...
																																																						<div class="offer-cont">
																																																							<div class="offer-list">
																																																								<div class="offer-img">
																																																									<img src="../../assets/images/offer/referral.png" alt="" @click="$router.push('/referral')">
																																																								</div>
																																																								<div class="offer-info flex">
																																																									<div class="left">
																																																										<h2>
																																																											<span class="title">Refer your friend to sign up</span>
																																																										</h2>
																																																									</div>
																																																									<div class="right" v-show="false">
																																																										<div class="log">
																																																								...
																																																								<div class="offer-more ">
																																																									<div class="rows flex space-between align-items-center">
																																																										<span> Start from 21th Nov 2017
																																																										</span>
																																																										<a @click="$router.push('/referral')">View Detail</a>
																																																									</div>
																																																								</div>
																																																							</div>
																																																						</div> -->
			...
			<!-- <div class="offer-cont">
																																																							<div class="offer-list">
																																																								<div class="offer-img">
																																																									<img src="../../assets/images/offer/diwali.jpg" alt="">
																																																								</div>
																																																								<div class="offer-info flex">
																																																									<div class="left">
																																																										<h2>
																																																											<span class="title">Get extra Rs.100 discount per order</span>
																																																										</h2>
																																																									</div>
																																																									<div class="right" v-show="false">
																																																										<div class="log">
																																																								...
																																																								<div class="offer-more ">
																																																									...
																																																									<div class="rows flex space-between align-items-center">
																																																										...
																																																										<a class="lapse">View Detail</a>
																																																									</div>
																																																								</div>
																																																							</div>
																																																						</div> -->

			<div class="offer-cont" v-for="(item,index) in offers" v-show="item.isUse == 1">
				<div class="offer-list">
					<div class="offer-img">
						<img @click="$router.push(item.href)" :src="item.url" alt="">
					</div>
					<div class="offer-info flex">
						<div class="left">
							<h2>
					...
					<div class="offer-more ">
						<div class="rows flex space-between align-items-center">
							...
							<a @click="$router.push(item.href)">View Detail</a>
						</div>
					</div>
				</div>
			</div>
