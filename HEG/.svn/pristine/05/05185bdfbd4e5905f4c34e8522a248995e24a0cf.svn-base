        ...
        <div class="container">
            <div class="content">
                ...
                <div class="form-group">
                    ...
                    <input type="text" v-model.number.trim="info.amount">
                ...
                <div class="form-group">
                    ...
                    <input type="text" v-model.number.trim="info.phone">
                </div>
...
export default {
    ...
    watch: {
        amount(newValue) {
            this.info.amount = Math.min.apply(null, [parseInt(this.info.amount), this.limitAmount]);
        }
    },
    methods: {
        addRechargeRequest() {
            if (this.isCookie()) {
                ...
                if (this.info.amount > 500000) {
                    Toast({
                        message: 'Every recharge amount cannot be over 500000',
                        duration: 1000
                    })
                    return false;
                }
                ...
                User.rechargeWallet(this, str).then((res) => {
                    if (res.success) {
                        // res.msg.returnUrl = 'https://m.happyeasygo.com/happywallet';
