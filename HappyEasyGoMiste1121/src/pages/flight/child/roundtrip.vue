									...
									<div class="flight-price">
										<div class="flight-price-detail">
											<div class="price-show flex content-end align-items-center">
												<span class="rs">RS.</span>
												<span>{{Math.round((item.bfp + item.gst - item.airlineDIS -50)/numberOfPeople) | formatDate}}</span>
											</div>
											<div class="cashback-detail flex content-end align-items-center">
												<span class="rs">RS.</span>
												<span>{{Math.round(item.flightInfoBack.fee.fees[item.flightInfoBack.fee.fees.length-1].cba * item.flightInfoBack.fee.cbd/numberOfPeople)}}</span>
											</div>
										</div>
								...
								<div class="flight-content flex space-between align-items-center" @click='onReturnItemClick(item,index)' :class="['flight-detail-list', (selectedReturnFlightIndex)==-1?'item-act':'item-def']">
									...
									<div class="flight-price">
										<div class="flight-price-detail">
											<div class="price-show flex content-end align-items-center">
												<span class="rs">RS.</span>
												<span>{{Math.round((item.bfp + item.gst - item.airlineDIS -50)/numberOfPeople)}}</span>
											</div>
											<div class="cashback-detail flex content-end align-items-center">
												<span class="rs">RS.</span>
												<span>{{Math.round(item.flightInfoBack.fee.fees[item.flightInfoBack.fee.fees.length-1].cba*item.flightInfoBack.fee.cbd/numberOfPeople)}}</span>
...
export default {
	...
	methods: {
		...
		onBothItemSelected() {
			...
			_roundTripDiscountManager.calculateDiscount(departFlight, returnFlight, this)
		},
